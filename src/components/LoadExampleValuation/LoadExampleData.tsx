...
const LoadExampleData = () => {
    ...
    const handleLoadExampleData = React.useCallback(() => {
        const valuationObjectsParametersValues = exampleValuationObjects.objectsParameters
        ...
        dispatch(setParametersObjects(Object.keys(exampleValuationObject.objectParameters)))
        dispatch(setValuationObjectParameters(exampleValuationObject.objectParameters))
        dispatch(setValuationObjectsParameters(exampleValuationObjects.objectsParameters))
        ...
        showToast(t('Loaded example valuation successfuly'))
    }, [dispatch, history, t])

    return (
        <Box className={classes.wrapper}>
            <Button variant={'outlined'} className={classes.loadButton} onClick={handleLoadExampleData}>{t('Load example work')}</Button>
        </Box>
    )
}
